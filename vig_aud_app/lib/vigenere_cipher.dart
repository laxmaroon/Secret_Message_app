...
String encryptAudio(String base64Audio, String key) {
  return encrypt(base64Audio, key);
}

String decryptAudio(String encryptedBase64Audio, String key) {
  return decrypt(encryptedBase64Audio, key);
}
